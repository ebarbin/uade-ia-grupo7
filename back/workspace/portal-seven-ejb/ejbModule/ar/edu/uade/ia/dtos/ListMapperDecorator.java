...
public class ListMapperDecorator implements Mapper {

	private Mapper baseMapper;

	public ListMapperDecorator(Mapper baseMapper) {
	...
	public <T> List<T> mapList(List<? extends Object> source, List<T> destination,
